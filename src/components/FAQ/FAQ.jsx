    ...
    return (
        <div className="px-20">
            ...
            <details className="collapse bg-[#0c1222] collapse-plus -mt-5 rounded-md">
                <summary className="collapse-title text-xl font-medium">What is the brand personality of Ford?</summary>
                ...
                {/* question: 02 */}
            <details className="collapse  bg-[#0c1222] collapse-plus -mt-5 rounded-md">
                <summary className="collapse-title text-xl font-medium">What is Toyota car famous for?</summary>
                <div className="collapse-content">
                ...
                {/* question: 03 */}
            <details className="collapse  bg-[#0c1222] collapse-plus -mt-5 rounded-md">
                <summary className="collapse-title text-xl font-medium">What is special about Honda car?</summary>
                <div className="collapse-content">
                ...
                {/* question: 04 */}
            <details className="collapse  bg-[#0c1222] collapse-plus -mt-5 rounded-md">
                <summary className="collapse-title text-xl font-medium">What kind of good is a Mercedes-Benz?</summary>
                <div className="collapse-content">
                ...
                {/* question: 05 */}
            <details className="collapse  bg-[#0c1222] collapse-plus -mt-5 rounded-md">
                <summary className="collapse-title text-xl font-medium">What is the best thing about BMW?</summary>
                <div className="collapse-content">
                ...
                {/* question: 06 */}
            <details className="collapse  bg-[#0c1222] collapse-plus -mt-5 rounded-md">
                <summary className="collapse-title text-xl font-medium">Why do people admire Tesla?</summary>
                <div className="collapse-content">
